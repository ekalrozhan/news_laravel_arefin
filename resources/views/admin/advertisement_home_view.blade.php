                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5>Above Search</h5>
                                    ...
                                    <div class="form-group mb-3">
                                        <label>URL</label>
                                        <input type="text" class="form-control" name="above_search_ad_url" value="{{ asset($home_ad_data->above_search_ad_url) }}">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label>Status</label>
                                        <div>
                                            <select name="above_search_ad_status" class="form-control">
                                                ...
                                                @endif>Show</option>
                                                <option value="Hide" 
                                                @if ($home_ad_data->above_search_ad_status == 'Hide')
                                                    selected
                                                @endif>Hide</option>
                                            </select>
                                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5>Above Footer</h5>
                                    ...
                                    <div class="form-group mb-3">
                                        <label>URL</label>
                                        <input type="text" class="form-control" name="above_footer_ad_url" value="{{ asset($home_ad_data->above_footer_ad_url) }}">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label>Status</label>
                                        <div>
                                            <select name="above_search_ad_status" class="form-control">
                                                ...
                                                @endif>Show</option>
                                                <option value="Hide"
                                                @if ($home_ad_data->above_footere_ad_status == 'Hide')
                                                selected
                                                @endif
                                                >Hide</option>
                                            </select>
